...
public class Main {
    public static void main(String[] args) {
        ...
        Ciudad tandil = new Ciudad("Tandil", "Buenos Aires", 140000);
        Ciudad laPlata = new Ciudad("La Plata", "Buenos Aires", 800000);
        Ciudad marDelPlata = new Ciudad("Mar del Plata", "Buenos Aires", 700000);
